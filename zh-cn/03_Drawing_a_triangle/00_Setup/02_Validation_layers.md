...
device level, which we'll see [later on](!zh-cn/Drawing_a_triangle/Setup/Logical_device_and_queues).
...
to look at [Vulkan devices in the system](!zh-cn/Drawing_a_triangle/Setup/Physical_devices_and_queue_families).
